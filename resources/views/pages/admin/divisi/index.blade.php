    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            <div class="x_title">
              <a class="btn btn-sm btn-primary" href="{{route('divisi.create')}}"> Tambah </a>
...
<x-button-edit link="{{route('divisi.edit',$data->id)}}" />
<x-button-delete link="{{route('divisi.destroy',$data->id)}}" />
                    </td>
                  </tr>
                    @empty
